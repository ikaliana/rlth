...
class Edit extends CI_Controller {
	...
	{
		$data = $this->InitiateTemplate(true,true,true,true,'edit/Home','','edit/home_custom_js');
		$this->OpenView($data);
	}

	public function detail()
	{
		$data = $this->InitiateTemplate(false,false,false,false,'edit/detail','','edit/detail_js');
		$this->OpenView($data);
	}
